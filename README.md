...
ts_dynamodb_example$ curl http://localhost:3000/
```
...
```bash
ts_dynamodb_example$ sam logs -n HelloWorldFunction --stack-name ts_dynamodb_example --tail
```
...
```bash
ts_dynamodb_example$ cd hello-world
...
```bash
sam delete --stack-name ts_dynamodb_example
```
